...
import sys
sys.path.append('C:/Users/Rishabh/Documents/nnUNet')
print(sys.path)
...
if __name__ == "__main__":
    ...
    #     all_in_gpu = False
    model =  "C:/Single-Centre-Gamma-Knife-(SC-GK)-models/ceT1/nnUNet/3d_fullres/Task700_VS/nnUNetTrainerV2__nnUNetPlansv2.1"
